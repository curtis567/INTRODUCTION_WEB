!(function(a) {
  a.fn.animatedModal = function(o) {
    function n() {
      l.css({ "z-index": i.zIndexOut }), i.afterClose();
    }
    function t() {
      i.afterOpen();
    }
    ...
    l.css(r),
      e.click(function(o) {
        o.preventDefault(),
          ...
          s == m &&
            (l.hasClass(i.modalTarget + "-off") &&
              (l.removeClass(i.animatedOut),
              l.removeClass(i.modalTarget + "-off"),
              l.addClass(i.modalTarget + "-on")),
            l.hasClass(i.modalTarget + "-on") &&
              (i.beforeOpen(),
      ...
      d.click(function(o) {
        o.preventDefault(),
          ...
          i.beforeClose(),
          l.hasClass(i.modalTarget + "-on") &&
            (l.removeClass(i.modalTarget + "-on"),
            l.addClass(i.modalTarget + "-off")),
          l.hasClass(i.modalTarget + "-off") &&
            (l.removeClass(i.animatedIn),
